...
typedef enum {SYSEND = 0, SYS01,SYS02,SYS03,SYS04,SYS05,SYS06,SYS07,SYSXX,SYSDTC,SYSDTC1,SYSDTC2,SYSDS,SYSVIN,SYSCALID1,SYSCALID2,SYSCALCVN1,SYSCALCVN2,SYSECUNAME,SYSSETDS,SYSOFF,SYSSS,SYSSE} MenuType;
...
typedef struct
{
    ...
    char* unit;
    u32 (*Equation1)(char* data,u8 *p,ERRORType *err);
    char* range;
} DSControlTypeDef;
/****************************函数声明**********************************/
void Bsp_Init(void);
